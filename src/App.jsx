...
import UISchemaEditor from "./components/UISchemaEditor/UISchemaEditor";
...
const App = () => {
  ...
  const handleUISchemaChange = (newSchema) => {
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ flex: 1 }}>
        ...
        <UISchemaEditor onSchemaChange={handleUISchemaChange} />
      </div>
      <div style={{ flex: 1 }}>
        <h2>Form Preview</h2>
        <FormRenderer
